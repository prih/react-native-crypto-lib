...
exports.ecdsaVerify = exports.ecdsaValidatePublic = exports.ecdsaValidatePrivate = exports.ecdsaSignAsync = exports.ecdsaSign = exports.ecdsaRecover = exports.ecdsaReadPublic = exports.ecdsaRandomPrivate = exports.ecdsaGetPublic = exports.ecdsaEcdh = void 0;
...
const ecdsaSignAsync = async (priv, digest) => {
  const sign = await CryptoLibNative.ecdsaSignAsync(priv.toString('base64'), digest.toString('base64'));
  const res = _buffer.Buffer.from(sign, 'base64');
  return {
    signature: res.slice(1),
    recId: Number(res[0])
  };
};
exports.ecdsaSignAsync = ecdsaSignAsync;
